...
description: Use this agent to orchestrate complex features using the PACT methodology (Prepare, Architect, Code, Test). This agent breaks down requests into phases and delegates to specialized agents. Use when you want structured, phase-by-phase development with comprehensive planning and documentation. Examples: <example>user: "I need to add a new payment processing system"assistant: "I'll use the pact-orchestrator agent to coordinate this feature development through the PACT phases"<commentary>Complex feature requiring planning, architecture, implementation, and testing - perfect for PACT orchestrator</commentary></example>
tools: Task, Glob, Grep, Read, Edit, Write, TodoWrite
color: purple
---
